...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_dir", type=str,
                        default="C:/Users/ARKAJYOTI DAS/Downloads/mini_competition_group_15/augmented_test_sample/JPEGImages",
                        help="Path to input test images")
    parser.add_argument("--out_dir", type=str,
                        default="C:/Users/ARKAJYOTI DAS/Downloads/group_15/group_15_output",
